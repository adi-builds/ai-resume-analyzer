        ...
        <div>
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <p className='text-sm text-gray-500'>Add details about your work Project here.</p>
                </div>
                    ...
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='grid md:grid-cols-2 gap-3'>
                            <input
                                ...
                                className='px-3 py-2 text-sm border border-gray-300 outline-none focus:ring focus:ring-blue-500 focus:border-blue-500 rounded-lg'
                            />
                            ...
                            <textarea
                                ...
                                rows={3}
                                className='md:col-span-2 w-full px-3 py-2 text-sm border border-gray-300 outline-none focus:ring focus:ring-blue-500 focus:border-blue-500 rounded-lg resize-none'
                            />
                        </div>
                    </div>
                ))}
