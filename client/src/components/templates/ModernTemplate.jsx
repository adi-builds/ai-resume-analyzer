		...
		<div className="max-w-4xl mx-auto bg-white text-gray-800">
			...
			<header className="p-8 text-white" style={{ backgroundColor: accentColor }}>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm ">
					...
					{data.personal_info?.Link2 && (
						<a target="_blank" href={data.personal_info?.Link2} className="flex items-center gap-2">
							<Link2 className="size-4" />
							<span className="break-all text-xs">{data.personal_info.Link2.split("https://www.")[1] ? data.personal_info.Link2.split("https://www.")[1] : data.personal_info.Link2}</span>
						</a>
					)}
