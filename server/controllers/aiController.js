...
//controller 4 enhanching a resume's professional summary
...
//controller for enhanching job description
...
//controller for uploading a resume to the db
...
export const uploadResume = async (req, res) => {
    ...
    education:[
        ...
        const parsedData = JSON.parse(extracteData)
